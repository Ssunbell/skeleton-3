...
-   **GPU**: 12.6 버전 CUDA (최소 6GB VRAM 권장)
-   **RAM**: 최소 8GB
-   **저장공간**: 최소 2GB
-   **운영체제**: Windows 10/11
...
```bash
uv add numpy==2.1.0 pandas==2.2.3 peft==0.17.1 torch==2.8.0 transformers==4.56.0 accelerate==1.10.1 datasets==4.0.0 trl==0.22.2 sqlparse==0.5.5 nltk==3.9.2 juypter==1.1.1 ipykernel==7.1.0 bitsandbytes==0.49.1
```
...
- PowerShell
`cd test-suite-sql-eval-master; python evaluation.py --gold gold.txt --pred predict.txt --db database/ --etype exec --plug_value`
